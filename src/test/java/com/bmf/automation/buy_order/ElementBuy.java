...
public enum ElementBuy {
	...
	CMS_CITY_LICK (By.xpath("//a[@class='rateselectcity mHidelogo']")),
	CMS_CITY_SELECT_AFTER_LINK_CLICKED (By.xpath("//select[@id='cityCodeDesk']")),
	...
	BUY_SELL_BUTTON_TWO(By.xpath("//button[@id='buysellatag']")),
