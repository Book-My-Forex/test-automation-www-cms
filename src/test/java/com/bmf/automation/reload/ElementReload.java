...
public enum ElementReload {
	...
	FOREX_CMS_RELOAD_SWITCH(By.xpath("//a[@href='#cardReload']")),
	FOREX_CMS_UNLOAD_SWITCH(By.xpath("//a[@href='#cardUnload']")),
	...
	CMS_KIT_CARD (By.xpath("//input[contains(@id,'reloadunload-cardNumber')]")),
