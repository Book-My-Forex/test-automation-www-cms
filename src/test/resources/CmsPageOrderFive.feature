Feature: verify cms pages create forexCard order flow https://www.bookmyforex.com/us-dollar/rates/delhi/
  #
 ...
 @prodcmswww
  Scenario: 1 User should login & buy  Order from cms page
    Given User opens BookMyForex url is 'bookmyforex.com/us-dollar/rates/delhi/#buyForex'
  ...
  Scenario: 2 User should login & sell  Order from cms page
    Given User opens BookMyForex url is 'bookmyforex.com/us-dollar/rates/delhi/#sellForex'
    When User enters correct credentials 'test.health100@yopmail.com', '7080234123' & 'Bmf@123456'
    And User given all below details to buy/sell currency/card
  ...
  Scenario: 3 to verify Transfer Money to australia with purpose(Medical Visit)
    Given User opens BookMyForex url is 'bookmyforex.com/us-dollar/rates/delhi/#moneytransfer'
    When User enters correct credentials 'test.health100@yopmail.com', '7080234123' & 'Bmf@123456'
  ...
  Scenario: 4 to Verify Reload,new trip with mapped kit number,TCS(Leisure Visit)
    Given User opens BookMyForex url is 'bookmyforex.com/us-dollar/rates/delhi/#cardReload'
