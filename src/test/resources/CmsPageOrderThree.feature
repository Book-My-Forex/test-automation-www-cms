Feature: verify cms pages create order flow https://www.bookmyforex.com/currency-exchange/delhi/connaught-place/
  ...
  Scenario: 1 User should login & buy  Order from cms page
    Given User opens BookMyForex url is 'bookmyforex.com/currency-exchange/delhi/connaught-place/'
