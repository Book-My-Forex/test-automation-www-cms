Feature: verify cms pages create order flow https://www.bookmyforex.com/currency-converter/usd-to-inr/analysis/
  ...
  Scenario: 1 User should login & buy Order forex card from cms page
    Given User opens BookMyForex url is 'bookmyforex.com/currency-converter/usd-to-inr/analysis/#buyForex'
  ...
  Scenario: 2 User should login & sell  Order from cms page
    Given User opens BookMyForex url is 'bookmyforex.com/currency-converter/usd-to-inr/analysis/#sellForex'
    When User enters correct credentials 'test.health100@yopmail.com', '7080234123' & 'Bmf@123456'
    And User given all below details to buy/sell currency/card
  ...
  Scenario: 3 to verify Transfer Money to australia with purpose(Medical Visit)
    Given User opens BookMyForex url is 'bookmyforex.com/currency-converter/usd-to-inr/analysis/#moneytransfer'
    When User enters correct credentials 'test.health100@yopmail.com', '7080234123' & 'Bmf@123456'
